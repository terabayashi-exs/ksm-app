...
import {
  ...
  mTournamentFormats,
  mVenues,
  tAdministratorSubscriptions,
  tAnnouncements,
  tDisciplinaryActions,
  tDisciplinarySettings,
  tEmailSendHistory,
  tFormatAccessGrants,
  tMatchBlocks,
  tMatchesFinal,
  tMatchStatus,
  tPasswordResetTokens,
  tPaymentHistory,
  tSponsorBanners,
  tSubscriptionUsage,
  tTournamentFiles,
  tTournamentGroups,
  tTournamentMatchOverrides,
  tTournamentNotifications,
  tTournamentPlayers,
  tTournamentRules,
  tTournaments,
  tTournamentTeams,
...
export const tTournamentMatchOverridesRelations = relations(
  tTournamentMatchOverrides,
  ({ one }) => ({
    tTournament: one(tTournaments, {
...
export const tAdministratorSubscriptionsRelations = relations(
  tAdministratorSubscriptions,
  ({ one }) => ({
    mSubscriptionPlan: one(mSubscriptionPlans, {
