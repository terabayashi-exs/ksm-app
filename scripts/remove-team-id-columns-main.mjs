// scripts/remove-team-id-columns-main.mjs
// main環境のt_matches_liveとt_matches_finalからteam1_id, team2_id, winner_team_idカラムを削除
...
console.log('🔧 Starting column removal migration for MAIN (PRODUCTION)...\n');
...
try {
  ...
  console.log('🎉 Migration completed successfully on MAIN (PRODUCTION)!');
  console.log('\n📊 Summary:');
  ...
  console.log('\n🚀 Production database is now fully migrated!');
