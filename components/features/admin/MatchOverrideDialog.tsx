    ...
    <div className="space-y-2 p-3 bg-gray-50 rounded-lg">
      ...
      <p className="text-xs text-gray-500">
        ...
        <span className="font-medium text-gray-700">
          {originalSource ? formatTeamSourceDisplay(originalSource) : "未設定"}
        </span>
      </p>
...
export function MatchOverrideDialog({
  ...
  const hasOverride =
    currentTeam1Source !== originalTeam1Source || currentTeam2Source !== originalTeam2Source;
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>この試合に出場するチームの進出元を変更できます。</DialogDescription>
        </DialogHeader>
