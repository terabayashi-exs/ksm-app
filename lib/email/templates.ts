...
おめでとうございます！
「${data.tournamentName}」への参加が正式に確定しましたのでお知らせいたします。
  ...
  <div class="container">
    ...
    <div class="content">
      <div class="success-box">
        ...
        <p style="margin: 0;">おめでとうございます！${data.teamName} 様の「${data.tournamentName}」への参加が正式に確定しました。</p>
      </div>
