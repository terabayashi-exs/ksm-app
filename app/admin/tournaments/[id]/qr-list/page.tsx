...
export default function QRListPage() {
  ...
  const fetchMatches = useCallback(async () => {
    try {
      ...
      if (tournamentData.success && tournamentData.data?.phases?.phases) {
        const sorted = [...tournamentData.data.phases.phases].sort(
  ...
  const uniqueBlocks = Array.from(blockMap.entries()).sort(
    (a, b) => a[1].matchBlockId - b[1].matchBlockId,
  );
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 print-inner-wrapper">
        ...
        <div className="no-print mb-6">
          ...
          <Card className="mb-6">
            ...
            <CardContent>
              <div
                className={`grid grid-cols-1 ${hasMatchdays ? "md:grid-cols-3" : "md:grid-cols-2"} gap-4`}
              >
                <div>
                      ...
                      <CardContent className="pt-0">
                        ...
                        <div className="mb-3 p-2 bg-gray-50 rounded-md matchup-area">
                          ...
                          <div className="flex items-center justify-center gap-3 mb-2">
                            <span className="font-bold text-lg team-name text-center flex-1 truncate max-w-[40%]">
                              {match.team1_name}
                            </span>
                          ...
                          {match.period_labels.length > 0 && (
                            <div className="score-vertical-area">
                              {match.period_labels.map((label, i) => (
                                <div
                                  key={i}
                                  className="flex items-center justify-center gap-3 score-row"
                                >
                                  <div className="flex items-center gap-1 flex-1 justify-end">
                                    <span className="text-xs text-gray-500 period-label">
                                      {label}
                                    </span>
                                    <div className="border border-gray-300 bg-white w-10 h-6 score-input-box"></div>
                                  </div>
                                  <span className="text-gray-300 text-xs shrink-0 score-separator">
                                    -
                                  </span>
                              ...
                              <div className="flex items-center justify-center gap-3 score-row mt-1 pt-1 border-t border-gray-300">
                                <div className="flex items-center gap-1 flex-1 justify-end">
                                  <span className="text-xs font-bold text-gray-700 period-label">
                                    計
                                  </span>
