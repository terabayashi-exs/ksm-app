          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm">
            <div>
              ...
              <ul className="space-y-1 text-primary">
                <li>
                  <strong>総申請数:</strong> 期間内の全辞退申請件数
                </li>
                <li>
                  <strong>承認率:</strong> 承認済み申請 ÷ 総申請数
                </li>
                <li>
                  <strong>辞退率:</strong> 大会の辞退申請数 ÷ 参加チーム数
                </li>
                <li>
                  <strong>処理時間:</strong> 申請から承認・却下までの日数
                </li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-1 text-primary">
                <li>
                  <strong>傾向分析:</strong> 辞退理由の傾向を把握し対策を検討
                </li>
                <li>
                  <strong>運営改善:</strong> 処理時間を短縮するための改善点を特定
                </li>
                <li>
                  <strong>大会計画:</strong> 辞退率の高い大会の要因を分析
                </li>
                <li>
                  <strong>予防対策:</strong> 頻出する辞退理由への事前対策
                </li>
              </ul>
            </div>
          </div>
