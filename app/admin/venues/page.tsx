...
export const metadata = { title: "会場マスタ管理" };
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-gray-900">会場マスタ管理</h1>
          <p className="text-sm text-gray-500 mt-1">会場情報の登録・編集・削除を行います</p>
        </div>
        <VenueManagement
