        ...
        <div className="mb-6">
          <div className="flex items-center gap-4 mb-4">
            ...
            <Button variant="ghost" asChild>
              <Link href={`/public/tournaments/${tournament.tournament_id}`} className="flex items-center text-gray-500 hover:text-gray-900">
        ...
        <div className="mb-8">
          <div className="flex items-center mb-4">
            ...
            <div>
              ...
              <p className="text-gray-500">トーナメント表</p>
            </div>
          </div>
