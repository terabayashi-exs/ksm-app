  ...
  try {
    ...
    const formattedRequests = withdrawalRequests.rows.map((row) => ({
      ...
      withdrawal_requested_at: row.withdrawal_requested_at
        ...
        : null,
      withdrawal_processed_at: row.withdrawal_processed_at
        ? String(row.withdrawal_processed_at)
        : null,
      withdrawal_processed_by: row.withdrawal_processed_by
        ? String(row.withdrawal_processed_by)
        : null,
      withdrawal_admin_comment: row.withdrawal_admin_comment
        ? String(row.withdrawal_admin_comment)
        : null,
