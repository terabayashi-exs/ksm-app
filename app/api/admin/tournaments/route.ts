...
export async function GET(request: NextRequest) {
  try {
    ...
    query +=
      " GROUP BY t.tournament_id, t.tournament_name, t.status, t.tournament_dates, t.recruitment_start_date, t.recruitment_end_date, t.created_at, t.updated_at, t.is_archived, t.team_count, t.group_id, v.venue_name, t.format_name";
